      ...
      <div className="mx-auto max-w-6xl px-5 text-center sm:px-8">
        ...
        <Reveal delay={120}>
          <p className="mx-auto mt-5 max-w-lg text-pretty text-lg leading-relaxed text-muted-foreground">
            Production sites for real clients — digital literacy for seniors, property
            maintenance lead generation, and the systems behind them.
          </p>
        </Reveal>
      </div>
          ...
          <div key={project.id}>
            <article className="overflow-hidden rounded-3xl border border-border bg-card">
              <a
                ...
                className="group relative block aspect-[16/9] w-full overflow-hidden border-b border-border bg-secondary outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
